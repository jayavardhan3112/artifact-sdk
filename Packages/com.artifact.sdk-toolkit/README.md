...
<root>
  ...
  ├── Editor
  │   ├── Artifact.SdkToolkit.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Artifact.SdkToolkit.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Artifact.SdkToolkit.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Artifact.SdkToolkit.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Artifact.SdkToolkit`.
...
| **displayName**     | A user-friendly name to appear in the Unity Editor (for example, in the Project Browser, the Package Manager window, etc.). For example: <br />`"Terrain Builder SDK"` <br/>**NOTE:** Use a display name that will help users understand what your package is intended for.                                                          |
...
- Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Artifact.SdkToolkit.Editor.asmdef`

- Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Artifact.SdkToolkit.asmdef`

- Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Artifact.SdkToolkit.Editor.Tests.asmdef`

  `Tests/Runtime/Artifact.SdkToolkit.Tests.asmdef`
